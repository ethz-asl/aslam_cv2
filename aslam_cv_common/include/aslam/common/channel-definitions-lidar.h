#ifndef ASLAM_CV_COMMON_CHANNEL_DEFINITIONS_LIDAR_H_
#define ASLAM_CV_COMMON_CHANNEL_DEFINITIONS_LIDAR_H_
...
#endif  // ASLAM_CV_COMMON_CHANNEL_DEFINITIONS_LIDAR_H_
