#ifndef ASLAM_COMMON_CHANNEL_DEFINITIONS_H_
#define ASLAM_COMMON_CHANNEL_DEFINITIONS_H_
...
/// it's in [0,360) degrees and measured relative to image coordinate system, ie
/// in clockwise.
...
/// The score by which the most strong keypoints have been selected. Can be used
/// for the further sorting or subsampling. (keypoint detector output)
DECLARE_CHANNEL(VISUAL_KEYPOINT_SCORES, Eigen::VectorXd)

/// The keypoint descriptors. (extractor output)
/// (cols are descriptors)
DECLARE_CHANNEL(
    DESCRIPTORS, Eigen::Matrix<unsigned char, Eigen::Dynamic, Eigen::Dynamic>)
...
#endif  // ASLAM_COMMON_CHANNEL_DEFINITIONS_H_
