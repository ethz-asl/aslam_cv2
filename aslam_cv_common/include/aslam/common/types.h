#ifndef ASLAM_COMMON_TYPES_H_
#define ASLAM_COMMON_TYPES_H_
...
enum class InterpolationMethod : int {
  ...
  /// Resampling using pixel area relation. It may be a prefered method for
  /// image decimation,
  /// as it gives moire-free results.  But when the image is zoomed, it is
  /// similar to the
