#ifndef ASLAM_MATCHER_MATCHING_ENGINE_H_
#define ASLAM_MATCHER_MATCHING_ENGINE_H_
...
class MatchingEngine {
 public:
  ...
  virtual bool match(
      ...
      typename MatchingProblem::MatchesWithScore* matches_A_B) = 0;
  ...
  virtual bool match(
    ...
    convertMatchesWithScoreToMatches<MatchingProblem>(
...
#endif  // ASLAM_MATCHER_MATCHING_ENGINE_H_
