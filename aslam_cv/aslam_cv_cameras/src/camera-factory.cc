                         ...
                         Distortion::Type distortion_type)
{
  ...
  switch (distortion_type) {
    ...
    default:
      LOG(FATAL) << "Unknown distortion model: "
          << static_cast<std::underlying_type<Distortion::Type>::type>(distortion_type);
  }
  ...
  switch (camera_type) {
    case Camera::Type::kPinhole:
      camera.reset(new PinholeCamera(intrinsics, image_width, image_height, distortion));
      break;
    case Camera::Type::kUnifiedProjection:
      camera.reset(new UnifiedProjectionCamera(intrinsics, image_width, image_height, distortion));
      break;
    default:
