...
#include "aslam/matcher/matching-engine-simple-one.h"

#include <vector>

namespace aslam {

template <typename MP> MatchingEngineSimpleOne2One<MP>::MatchingEngineSimpleOne2One() {}
template <typename MP> MatchingEngineSimpleOne2One<MP>::~MatchingEngineSimpleOne2One() {}


template <typename MP> 
bool MatchingEngineSimpleOne2One<MP>::match(MP &problem)
{
