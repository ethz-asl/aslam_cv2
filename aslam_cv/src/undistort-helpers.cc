...
static void getUndistortRectangles(const aslam::Camera& input_camera, bool undistort_to_pinhole,
...
Eigen::Matrix3d getOptimalNewCameraMatrix(const aslam::Camera& input_camera,
