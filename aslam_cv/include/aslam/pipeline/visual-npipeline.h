...
class VisualNPipeline {
 public:
  ...
  /// @param[in]  timestamp_tolerance_ns  Timestamp tolereance for frames to be considered
  ///                                     belonging together in [nanoseconds].
  /// @param[return]  A shared pointer to the visual npipeline.
