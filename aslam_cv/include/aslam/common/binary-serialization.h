...
#ifndef ASLAM_COMMON_BINARY_SERIALIZATION_H_
#define ASLAM_COMMON_BINARY_SERIALIZATION_H_
...
void Serialize(const char* memory_start, unsigned int memory_block_length_bytes,
               std::ostream* out);

void Deserialize(char* memory_start, unsigned int memory_block_length_bytes,
                 std::istream* in);

void Serialize(const unsigned char* memory_start,
               unsigned int memory_block_length_bytes, std::ostream* out);

void Deserialize(unsigned char* memory_start,
                 unsigned int memory_block_length_bytes, std::istream* in);

void Serialize(const sm::HashId& value, std::ostream* out);

void Deserialize(sm::HashId* value, std::istream* in);
...
#endif  // ASLAM_COMMON_BINARY_SERIALIZATION_H_
