...
TEST(EigenYamlSerialization, EigenYamlSerialization_Dynamic_SizeDouble) {
  CHECK_TEST("Dynamic size double", double, Eigen::Dynamic, Eigen::Dynamic,
             "double_dynamic.yaml");
}
TEST(EigenYamlSerialization, EigenYamlSerialization_Dynamic_SizeVectorDouble) {
  CHECK_TEST("Dynamic vector col double", double, 1, Eigen::Dynamic,
             "double_dynveccol.yaml");
}
TEST(EigenYamlSerialization,
     EigenYamlSerialization_Dynamic_SizeVectorRowDouble) {
  CHECK_TEST("Dynamic vector row double", double, Eigen::Dynamic, 1,
...
TEST(EigenYamlSerialization, EigenYamlSerialization_Dynamic_SizeInt) {
  CHECK_TEST("Dynamic size int", int, Eigen::Dynamic, Eigen::Dynamic,
             "int_dynamic.yaml");
}
TEST(EigenYamlSerialization, EigenYamlSerialization_Dynamic_SizeVectorColInt) {
  CHECK_TEST("Dynamic vector col int", int, 1, Eigen::Dynamic,
             "int_dynveccol.yaml");
}
TEST(EigenYamlSerialization, EigenYamlSerialization_Dynamic_SizeVectorRowInt) {
  CHECK_TEST("Dynamic vector row int", int, Eigen::Dynamic, 1,
             "int_dynvecrow.yaml");
}
