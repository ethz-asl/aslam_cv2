  ...
  inline void createRandomKeypointsAndLandmarksWithinSearchRegion(
    ...
    *p_C_landmarks = Eigen::Matrix3Xd(3, num_keypoints);
    ...
    for (size_t keypoint_index = 0u; keypoint_index < num_keypoints; ++keypoint_index) {
      ...
      // The landmark is generated by moving its projection to a random point inside the
      // search radius around the matching keypoint, and then scaling the ray to place
      // the landmark away from the camera in 3D space.
